...
urlpatterns = [
    ...
    # RpkiOrganization
    path('organization/', views.RpkiOrganizationListView.as_view(), name='rpkiorganization_list'),
    path('organization/add/', views.RpkiOrganizationEditView.as_view(), name='rpkiorganization_add'),
    path('organization/<int:pk>/', views.RpkiOrganizationView.as_view(), name='rpkiorganization'),
    path('organization/<int:pk>/edit/', views.RpkiOrganizationEditView.as_view(), name='rpkiorganization_edit'),
    path('organization/<int:pk>/delete/', views.RpkiOrganizationDeleteView.as_view(), name='rpkiorganization_delete'),
    path('organization/<int:pk>/', include(get_model_urls('netbox_rpki', 'rpkiorganization'))),
    # RpkiRoa
