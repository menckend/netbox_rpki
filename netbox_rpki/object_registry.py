...
OBJECT_SPECS = (
    ...
    build_standard_object_spec(
        ...
        api_fields=("name", "organization", "source_reconciliation_run", "status", "summary_json"),
        brief_fields=("name", "organization", "source_reconciliation_run", "status"),
        filter_fields=("name", "organization", "source_reconciliation_run", "status", "tenant"),
        search_fields=("name__icontains", "comments__icontains"),
        graphql_fields=(("name", "str"), ("organization_id", "id"), ("source_reconciliation_run_id", "id"), ("status", "str")),
        navigation_group="Intent",
    ...
    build_standard_object_spec(
        ...
        api_fields=("name", "change_plan", "action_type", "roa_intent", "roa", "imported_authorization", "before_state_json", "after_state_json", "reason"),
        brief_fields=("name", "change_plan", "action_type", "roa_intent", "roa", "imported_authorization"),
        filter_fields=("name", "change_plan", "action_type", "roa_intent", "roa", "imported_authorization", "tenant"),
        search_fields=("name__icontains", "reason__icontains", "comments__icontains"),
        graphql_fields=(("name", "str"), ("change_plan_id", "id"), ("action_type", "str"), ("roa_intent_id", "id"), ("roa_id", "id"), ("imported_authorization_id", "id")),
        navigation_group="Intent",
