...
OBJECT_SPECS = (
    ...
    build_standard_object_spec(
        ...
        api_fields=("name", "roa_intent", "roa", "match_kind", "is_best_match", "details_json"),
        brief_fields=("name", "roa_intent", "roa", "match_kind"),
        filter_fields=("name", "roa_intent", "roa", "match_kind", "is_best_match", "tenant"),
        search_fields=("name__icontains", "comments__icontains"),
        graphql_fields=(
            ("name", "str"),
            ("roa_intent_id", "id"),
    ...
    build_standard_object_spec(
        ...
        brief_fields=("name", "intent_profile", "comparison_scope", "status"),
        filter_fields=("name", "organization", "intent_profile", "basis_derivation_run", "comparison_scope", "status", "tenant"),
        search_fields=("name__icontains", "comments__icontains"),
        graphql_fields=(
            ("name", "str"),
            ("organization_id", "id"),
    ...
    build_standard_object_spec(
        ...
        brief_fields=("name", "roa_intent", "result_type", "severity"),
        filter_fields=("name", "reconciliation_run", "roa_intent", "result_type", "severity", "best_roa", "tenant"),
        search_fields=("name__icontains", "comments__icontains"),
        graphql_fields=(
            ("name", "str"),
    ...
    build_standard_object_spec(
        ...
        brief_fields=("name", "roa", "result_type", "severity"),
        filter_fields=("name", "reconciliation_run", "roa", "result_type", "severity", "tenant"),
        search_fields=("name__icontains", "comments__icontains"),
        graphql_fields=(
            ("name", "str"),
            ("reconciliation_run_id", "id"),
