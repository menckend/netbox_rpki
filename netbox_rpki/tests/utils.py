...
def create_test_lifecycle_health_policy(
    ...
    **kwargs,
    ...
    if provider_account is not None and provider_account.organization_id != organization.pk:
...
def create_test_roa_change_plan(
    ...
    **kwargs,
    ...
    return rpki_models.ROAChangePlan.objects.create(
        ...
        approved_at=approved_at,
        approved_by=approved_by,
        secondary_approved_at=secondary_approved_at,
        secondary_approved_by=secondary_approved_by,
...
def create_test_roa_change_plan_rollback_bundle(
    name='ROA Change Plan Rollback Bundle 1',
    organization=None,
    source_plan=None,
    rollback_delta_json=None,
    item_count=0,
    status=None,
    ticket_reference='',
    change_reference='',
    ...
    **kwargs,
    ...
    if source_plan is None:
        source_plan = create_test_roa_change_plan(organization=organization)
    if organization is None:
        organization = source_plan.organization
    return rpki_models.ROAChangePlanRollbackBundle.objects.create(
        name=name,
        organization=organization,
        source_plan=source_plan,
        tenant=source_plan.tenant,
        rollback_delta_json=rollback_delta_json or {},
        ...
        applied_at=applied_at,
        failed_at=failed_at,
        apply_response_json=apply_response_json or {},
...
def create_test_aspa_change_plan_rollback_bundle(
    name='ASPA Change Plan Rollback Bundle 1',
    organization=None,
    source_plan=None,
    rollback_delta_json=None,
    item_count=0,
    ...
    **kwargs,
    ...
    if source_plan is None:
        source_plan = create_test_aspa_change_plan(organization=organization)
    if organization is None:
        organization = source_plan.organization
